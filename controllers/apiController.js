...
module.exports = {
  landingPage: async (req, res) => {
    try {
      ...
      const testimonial = {
        _id: "asd1293uasdads1",
        imageUrl: "images/testimonial2.avif",
        name: "Happy Family",
        rate: 4.55,
  ...
  detailPage: async (req, res) => {
    try {
      ...
      const testimonial = {
        _id: "asd1293uasdads1",
        imageUrl: "images/testimonial1.avif",
        name: "Happy Family",
        rate: 4.55,
        content: "What a great trip with my family and I should try again next time soon ...",
        familyName: "Angga",
      ...
      res.status(200).json({
        ...item._doc, //agar item tidak tampil
        bank,
        testimonial,
      });
    } catch (error) {
  ...
  bookingPage: async (req, res) => {
    ...
    if (idItem === "" || duration === "" || bookingStartDate === "" || bookingEndDate === "" || firstName === "" || lastName === "" || email === "" || phoneNumber === "" || accountHolder === "" || bankFrom === "") {
